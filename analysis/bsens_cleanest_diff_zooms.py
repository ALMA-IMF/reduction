...
def bsens_cleanest_diff(finaliter_prefix_b3, finaliter_prefix_b6,
    ...
    ax.imshow(diff_b3.to(u.mJy)[0].value, norm=simple_norm(diff_b3.to(u.mJy)[0].value, **normpars_b3), cmap='gray')
    ...
    ax2.imshow(diff_b6.to(u.mJy)[0].value, norm=simple_norm(diff_b6.to(u.mJy)[0].value, **normpars_b6), cmap='gray')
