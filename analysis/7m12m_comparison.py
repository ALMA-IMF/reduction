...
cwd = os.getcwd()
basepath = '/orange/adamginsburg/ALMA_IMF/RestructuredImagingResults/'
os.chdir(basepath)

import imstats


#tbl = imstats.savestats(basepath=basepath, filetype='')
#
...
for field in "G008.67 G337.92 W43-MM3 G328.25 G351.77 G012.80 G327.29 W43-MM1 G010.62 W51-IRS2 W43-MM2 G333.60 G338.93 W51-E G353.41".split():
    for band in (3,6):
        for config in ("7M12M",):
            ...
            fns = glob.glob(f"{basepath}/{field}/B{band}/7m12m/*_{config}_robust0_*final*.image.tt0.pbcor")
            if len(fns) > 1:
            ...
            if not os.path.exists(f"{basepath}/{field}/B{band}/comparisons_7m12m/"):
                os.mkdir(f"{basepath}/{field}/B{band}/comparison_7m12ms/")
            pl.savefig(f"{basepath}/{field}/B{band}/comparison_7m12ms/{field}_B{band}_{config}_7m12m_vs_cleanest_comparison.png",
...
#tbl.write('/orange/adamginsburg/web/secure/ALMA-IMF/tables/metadata_7m12m_cleanest.ecsv',
#          overwrite=True)
#tbl.write('/orange/adamginsburg/web/secure/ALMA-IMF/tables/metadata_7m12m_cleanest.html',
#          formats=formats,
#          format='ascii.html', overwrite=True)
#tbl.write('/orange/adamginsburg/web/secure/ALMA-IMF/tables/metadata_7m12m_cleanest.tex',
#          formats=formats,
#          overwrite=True)
#tbl.write('/orange/adamginsburg/web/secure/ALMA-IMF/tables/metadata_7m12m_cleanest.js.html',
#          #formats=formats,
#          format='jsviewer')
