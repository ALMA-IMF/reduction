...
os.chdir(basepath)
sharepath = '/orange/adamginsburg/web/secure/ALMA-IMF/June2021Release/'
...
#tbl = Table.read('/orange/adamginsburg/web/secure/ALMA-IMF/June2021/tables/metadata.ecsv')
...
#tbl.add_column(Column(name='nobright', data=['no2nhp' in fn or 'noco' in fn for fn in tbl['filename']]))
...
for bp in ('/orange/adamginsburg/web/secure/ALMA-IMF/',
    ...
    tbl.write('{bp}/June2021Release/tables/metadata_sc.ecsv'.format(bp=bp),
              overwrite=True)
    tbl.write('{bp}/June2021Release/tables/metadata_sc.html'.format(bp=bp),
              formats=formats,
              format='ascii.html', overwrite=True)
    tbl.write('{bp}/June2021Release/tables/metadata_sc.tex'.format(bp=bp),
              formats=formats,
              overwrite=True)
    tbl.write('{bp}/June2021Release/tables/metadata_sc.js.html'.format(bp=bp),
              #formats=formats,
              format='jsviewer')
