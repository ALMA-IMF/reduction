...
def bsens_comparison(release="June2021Release"):
    ...
    tbl = Table.read(f'/orange/adamginsburg/ALMA_IMF/2017.1.01355.L/{release}/tables/metadata_image.tt0.ecsv')
...
if __name__ == "__main__":
    bsens_comparison("June2021Release")
    bsens_comparison("February2021Release")
