...
#for fn in glob.glob("G353*_12M_robust0_*finaliter*.image.tt0.fits"):
    ...
    shutil.copy(f'{imname}_selfcal_anim.gif', '/orange/adamginsburg/web/secure/adamginsburg/ALMA-IMF/October2020Release/selfcal_animations/')
    #shutil.copy(f'{imname}_image_selfcal_anim.gif', '/orange/adamginsburg/web/secure/adamginsburg/ALMA-IMF/Feb2020/selfcal_animations/')
