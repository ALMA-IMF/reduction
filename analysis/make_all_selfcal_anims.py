...
for fn in glob.glob("*_12M_robust0**finaliter*.image.tt0.fits"):
    imname = fn.split("_selfcal")[0]
    print(imname)
    make_anim(imname)
    make_anim_single(imname, 'image')

    shutil.copy(f'{imname}_selfcal_anim.gif', '/bio/web/secure/adamginsburg/ALMA-IMF/Feb2020/selfcal_animations/')
