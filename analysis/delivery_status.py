...
cwd = os.getcwd()
basepath = '/orange/adamginsburg/web/secure/adamginsburg/ALMA-IMF/October2020Release'
os.chdir(basepath)
...
tbl.write('/orange/adamginsburg/web/secure/adamginsburg/ALMA-IMF/October2020Release/tables/delivery_metadata.ecsv',
          overwrite=True)
tbl.write('/orange/adamginsburg/web/secure/adamginsburg/ALMA-IMF/October2020Release/tables/delivery_metadata.html',
          format='ascii.html', overwrite=True)
tbl.write('/orange/adamginsburg/web/secure/adamginsburg/ALMA-IMF/October2020Release/tables/delivery_metadata.js.html',
          #formats=formats,
          format='jsviewer')
...
gtbl = Table(grid)
gtbl.sort('region')
gtbl.write('/orange/adamginsburg/web/secure/adamginsburg/ALMA-IMF/October2020Release/tables/delivery_grid.html',
