...
os.chdir(basepath)
sharepath = '/orange/adamginsburg/web/secure/adamginsburg/ALMA-IMF/October2020Release/'
...
#tbl = Table.read('/orange/adamginsburg/web/secure/adamginsburg/ALMA-IMF/October2020/tables/metadata.ecsv')
tbl = Table.read('/orange/adamginsburg/ALMA_IMF/2017.1.01355.L/October2020Release/tables/metadata_image.tt0.ecsv')
#tbl = Table.read('/orange/adamginsburg/web/secure/adamginsburg/ALMA-IMF/October2020Release/tables/metadata.ecsv')
...
for bp in ('/orange/adamginsburg/web/secure/adamginsburg/ALMA-IMF/',
    ...
    tbl.write('{bp}/October2020Release/tables/metadata_sc.ecsv'.format(bp=bp),
              overwrite=True)
    tbl.write('{bp}/October2020Release/tables/metadata_sc.html'.format(bp=bp),
              formats=formats,
              format='ascii.html', overwrite=True)
    tbl.write('{bp}/October2020Release/tables/metadata_sc.tex'.format(bp=bp),
              formats=formats,
              overwrite=True)
    tbl.write('{bp}/October2020Release/tables/metadata_sc.js.html'.format(bp=bp),
              #formats=formats,
              format='jsviewer')
