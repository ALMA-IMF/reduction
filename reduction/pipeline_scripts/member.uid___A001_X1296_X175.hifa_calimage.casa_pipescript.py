...
context.set_state('ProjectStructure', 'ous_part_id', 'X1993880024')
context.set_state('ProjectStructure', 'ous_title', 'Undefined')
context.set_state('ProjectStructure', 'ppr_file', 'PPR_uid___A001_X1296_X176.xml')
...
context.set_state('ProjectStructure', 'ousstatus_entity_id', 'uid://A001/X1296/X175')
try:
    hifa_importdata(vis=['uid___A002_Xc6a3db_X494f', 'uid___A002_Xc6fa08_X33b7'], session=['session_1', 'session_2'])
    ...
    flagdata(vis='uid___A002_Xc6a3db_X494f.ms.h_tsyscal.s6_1.tsyscal.tbl',mode='manual',field='G327.29',spw='26:254~280')
    flagdata(vis='uid___A002_Xc6fa08_X33b7.ms.h_tsyscal.s6_3.tsyscal.tbl',mode='manual',field='G327.29',spw='26:254~280')
