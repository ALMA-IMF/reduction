...
context.set_state('ProjectStructure', 'ous_part_id', 'X380615310')
context.set_state('ProjectStructure', 'ous_title', 'Undefined')
context.set_state('ProjectStructure', 'ppr_file', '/opsw/alma/dared/opt/c5r1/mnt/dataproc/2017.1.01355.L_2018_03_27T11_37_17.408/SOUS_uid___A001_X1296_X137/GOUS_uid___A001_X1296_X138/MOUS_uid___A001_X1296_X139/working/PPR_uid___A001_X1296_X13a.xml')
...
context.set_state('ProjectStructure', 'ousstatus_entity_id', 'uid://A001/X1296/X139')
try:
    hifa_importdata(vis=['uid___A002_Xca9e6b_Xc252'], session=['session_1'])
