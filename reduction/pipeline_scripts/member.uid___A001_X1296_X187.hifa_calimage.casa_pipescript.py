...
context.set_state('ProjectStructure', 'ous_part_id', 'X1162184736')
context.set_state('ProjectStructure', 'ous_title', 'Undefined')
context.set_state('ProjectStructure', 'ppr_file', '/opt/dared/opt/qa56.1712.1/mnt/dataproc/2017.1.01355.L_2018_07_16T05_59_49.068/SOUS_uid___A001_X1296_X183/GOUS_uid___A001_X1296_X184/MOUS_uid___A001_X1296_X187/working/PPR_uid___A001_X1296_X188.xml')
...
context.set_state('ProjectStructure', 'ousstatus_entity_id', 'uid://A001/X1296/X187')
try:
    hifa_importdata(vis=['uid___A002_Xcf196f_Xa24c'], session=['session_1'])
