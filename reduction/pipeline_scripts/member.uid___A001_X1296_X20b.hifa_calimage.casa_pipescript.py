...
context.set_state('ProjectStructure', 'ous_part_id', 'X876129528')
context.set_state('ProjectStructure', 'ous_title', 'Undefined')
context.set_state('ProjectStructure', 'ppr_file', '/opt/dared/opt/qa56.1712.1/mnt/dataproc/2017.1.01355.L_2018_07_16T21_06_12.716/SOUS_uid___A001_X1296_X207/GOUS_uid___A001_X1296_X208/MOUS_uid___A001_X1296_X20b/working/PPR_uid___A001_X1296_X20c.xml')
...
context.set_state('ProjectStructure', 'ousstatus_entity_id', 'uid://A001/X1296/X20b')
try:
    hifa_importdata(vis=['uid___A002_Xcfae6a_Xbb8'], session=['session_1'])
