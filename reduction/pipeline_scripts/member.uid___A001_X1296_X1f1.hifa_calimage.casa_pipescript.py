...
context.set_state('ProjectStructure', 'ous_part_id', 'X435978372')
context.set_state('ProjectStructure', 'ous_title', 'Undefined')
context.set_state('ProjectStructure', 'ppr_file', '/opt/dared/opt/c5r1/mnt/dataproc/2017.1.01355.L_2017_12_22T19_18_46.321/SOUS_uid___A001_X1296_X1ed/GOUS_uid___A001_X1296_X1ee/MOUS_uid___A001_X1296_X1f1/working/PPR_uid___A001_X1296_X1f2.xml')
...
context.set_state('ProjectStructure', 'ousstatus_entity_id', 'uid://A001/X1296/X1f1')
try:
    hifa_importdata(vis=['uid___A002_Xc5d6d1_X500c', 'uid___A002_Xc77d4f_X3cc5'], session=['session_1', 'session_2'])
    fixsyscaltimes(vis = 'uid___A002_Xc77d4f_X3cc5.ms')# SACM/JAO - Fixes
    fixsyscaltimes(vis = 'uid___A002_Xc5d6d1_X500c.ms')# SACM/JAO - Fixes
