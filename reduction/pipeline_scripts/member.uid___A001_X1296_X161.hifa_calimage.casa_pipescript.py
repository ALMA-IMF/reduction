...
context.set_state('ProjectStructure', 'ous_part_id', 'X2017267905')
context.set_state('ProjectStructure', 'ous_title', 'Undefined')
context.set_state('ProjectStructure', 'ppr_file', '/opt/dared/opt/c5r1/mnt/dataproc/2017.1.01355.L_2018_04_06T15_47_30.444/SOUS_uid___A001_X1296_X15f/GOUS_uid___A001_X1296_X160/MOUS_uid___A001_X1296_X161/working/PPR_uid___A001_X1296_X162.xml')
...
context.set_state('ProjectStructure', 'ousstatus_entity_id', 'uid://A001/X1296/X161')
try:
    hifa_importdata(vis=['uid___A002_Xcb4a8e_X308f'], session=['session_1'])
    fixsyscaltimes(vis = 'uid___A002_Xcb4a8e_X308f.ms')# SACM/JAO - Fixes
