...
context.set_state('ProjectStructure', 'ous_part_id', 'X2042830096')
context.set_state('ProjectStructure', 'ous_title', 'Undefined')
context.set_state('ProjectStructure', 'ppr_file', 'PPR_uid___A001_X1296_X1d6.xml')
...
context.set_state('ProjectStructure', 'ousstatus_entity_id', 'uid://A001/X1296/X1d5')
try:
    hifa_importdata(vis=['uid___A002_Xc6d2f9_X4b79'], session=['session_1'])
    ...
    flagdata(mode='manual',vis='uid___A002_Xc6d2f9_X4b79.ms.h_tsyscal.s6_1.tsyscal.tbl',field='G353.41',spw='16:940~1100')
