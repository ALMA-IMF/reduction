...
context.set_state('ProjectStructure', 'ous_part_id', 'X329531892')
context.set_state('ProjectStructure', 'ous_title', 'Undefined')
context.set_state('ProjectStructure', 'ppr_file', '/opt/dared/opt/c5r1/mnt/dataproc/2017.1.01355.L_2018_04_04T22_14_41.989/SOUS_uid___A001_X1296_X14b/GOUS_uid___A001_X1296_X14c/MOUS_uid___A001_X1296_X14d/working/PPR_uid___A001_X1296_X14e.xml')
...
context.set_state('ProjectStructure', 'ousstatus_entity_id', 'uid://A001/X1296/X14d')
try:
    hifa_importdata(vis=['uid___A002_Xca464b_X3b17'], session=['session_1'])
    fixsyscaltimes(vis = 'uid___A002_Xca464b_X3b17.ms')# SACM/JAO - Fixes
