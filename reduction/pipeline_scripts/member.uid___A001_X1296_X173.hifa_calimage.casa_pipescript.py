...
context.set_state('ProjectStructure', 'ous_part_id', 'X906127015')
context.set_state('ProjectStructure', 'ous_title', 'Undefined')
context.set_state('ProjectStructure', 'ppr_file', '/opt/dared/opt/c5r1/mnt/dataproc/2017.1.01355.L_2018_05_03T18_35_31.792/SOUS_uid___A001_X1296_X171/GOUS_uid___A001_X1296_X172/MOUS_uid___A001_X1296_X173/working/PPR_uid___A001_X1296_X174.xml')
...
context.set_state('ProjectStructure', 'ousstatus_entity_id', 'uid://A001/X1296/X173')
try:
    hifa_importdata(vis=['uid___A002_Xcb4a8e_X2bb9', 'uid___A002_Xcca365_X167f'], session=['session_1', 'session_2'])
    fixsyscaltimes(vis = 'uid___A002_Xcca365_X167f.ms')# SACM/JAO - Fixes
    fixsyscaltimes(vis = 'uid___A002_Xcb4a8e_X2bb9.ms')# SACM/JAO - Fixes
