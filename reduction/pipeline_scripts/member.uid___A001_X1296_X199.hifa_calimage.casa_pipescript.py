...
context.set_state('ProjectStructure', 'ous_part_id', 'X418927098')
context.set_state('ProjectStructure', 'ous_title', 'Undefined')
context.set_state('ProjectStructure', 'ppr_file', '/opt/dared/opt/c5r1/mnt/dataproc/2017.1.01355.L_2018_03_28T00_33_06.092/SOUS_uid___A001_X1296_X197/GOUS_uid___A001_X1296_X198/MOUS_uid___A001_X1296_X199/working/PPR_uid___A001_X1296_X19a.xml')
...
context.set_state('ProjectStructure', 'ousstatus_entity_id', 'uid://A001/X1296/X199')
try:
    hifa_importdata(vis=['uid___A002_Xca464b_X3319', 'uid___A002_Xca9e6b_Xc5c4'], session=['session_1', 'session_2'])
    fixsyscaltimes(vis = 'uid___A002_Xca464b_X3319.ms')# SACM/JAO - Fixes
    fixsyscaltimes(vis = 'uid___A002_Xca9e6b_Xc5c4.ms')# SACM/JAO - Fixes
