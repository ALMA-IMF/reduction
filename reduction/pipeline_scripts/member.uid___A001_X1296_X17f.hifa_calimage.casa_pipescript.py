...
context.set_state('ProjectStructure', 'ous_part_id', 'X1529579086')
context.set_state('ProjectStructure', 'ous_title', 'Undefined')
context.set_state('ProjectStructure', 'ppr_file', '/opsw/alma/dared/opt/c5r1/mnt/dataproc/2017.1.01355.L_2017_11_01T11_05_17.409/SOUS_uid___A001_X1296_X179/GOUS_uid___A001_X1296_X17a/MOUS_uid___A001_X1296_X17f/working/PPR_uid___A001_X1296_X180.xml')
...
context.set_state('ProjectStructure', 'ousstatus_entity_id', 'uid://A001/X1296/X17f')
try:
    hifa_importdata(vis=['uid___A002_Xc5c71f_X34ad', 'uid___A002_Xc63024_X2cf5'], session=['session_1', 'session_2'])
    fixsyscaltimes(vis = 'uid___A002_Xc63024_X2cf5.ms')# SACM/JAO - Fixes
    fixsyscaltimes(vis = 'uid___A002_Xc5c71f_X34ad.ms')# SACM/JAO - Fixes
