...
context.set_state('ProjectStructure', 'ous_part_id', 'X886635769')
context.set_state('ProjectStructure', 'ous_title', 'Undefined')
context.set_state('ProjectStructure', 'ppr_file', '/opt/dared/opt/c5r1/mnt/dataproc/2017.1.01355.L_2018_04_28T20_04_13.760/SOUS_uid___A001_X1296_X105/GOUS_uid___A001_X1296_X106/MOUS_uid___A001_X1296_X109/working/PPR_uid___A001_X1296_X10a.xml')
...
context.set_state('ProjectStructure', 'ousstatus_entity_id', 'uid://A001/X1296/X109')
try:
    hifa_importdata(vis=['uid___A002_Xcc626d_Xb34f'], session=['session_2'])
    fixsyscaltimes(vis = 'uid___A002_Xcc626d_Xb34f.ms')# SACM/JAO - Fixes
