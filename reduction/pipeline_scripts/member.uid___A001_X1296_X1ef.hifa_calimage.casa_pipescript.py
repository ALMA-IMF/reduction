...
context.set_state('ProjectStructure', 'ous_part_id', 'X808860404')
context.set_state('ProjectStructure', 'ous_title', 'Undefined')
context.set_state('ProjectStructure', 'ppr_file', '/opt/dared/opt/c5r1/mnt/dataproc/2017.1.01355.L_2018_05_09T20_13_18.721/SOUS_uid___A001_X1296_X1ed/GOUS_uid___A001_X1296_X1ee/MOUS_uid___A001_X1296_X1ef/working/PPR_uid___A001_X1296_X1f0.xml')
...
context.set_state('ProjectStructure', 'ousstatus_entity_id', 'uid://A001/X1296/X1ef')
try:
    hifa_importdata(vis=['uid___A002_Xccea8d_Xc916'], session=['session_1'])
    fixsyscaltimes(vis = 'uid___A002_Xccea8d_Xc916.ms')# SACM/JAO - Fixes
