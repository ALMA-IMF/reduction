...
context.set_state('ProjectStructure', 'ous_part_id', 'X886603216')
context.set_state('ProjectStructure', 'ous_title', 'Undefined')
context.set_state('ProjectStructure', 'ppr_file', '/opsw/alma/dared/opt/qa56.1712.1/mnt/dataproc/2017.1.01355.L_2018_06_25T10_23_03.093/SOUS_uid___A001_X1296_X197/GOUS_uid___A001_X1296_X198/MOUS_uid___A001_X1296_X19b/working/PPR_uid___A001_X1296_X19c.xml')
...
context.set_state('ProjectStructure', 'ousstatus_entity_id', 'uid://A001/X1296/X19b')
try:
    hifa_importdata(vis=['uid___A002_Xce8d43_X3181'], session=['session_1'])
