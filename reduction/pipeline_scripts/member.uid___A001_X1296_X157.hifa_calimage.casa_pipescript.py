...
context.set_state('ProjectStructure', 'ous_part_id', 'X1301879899')
context.set_state('ProjectStructure', 'ous_title', 'Undefined')
context.set_state('ProjectStructure', 'ppr_file', '/opt/dared/opt/c5r1/mnt/dataproc/2017.1.01355.L_2018_01_25T21_40_58.707/SOUS_uid___A001_X1296_X155/GOUS_uid___A001_X1296_X156/MOUS_uid___A001_X1296_X157/working/PPR_uid___A001_X1296_X158.xml')
...
context.set_state('ProjectStructure', 'ousstatus_entity_id', 'uid://A001/X1296/X157')
try:
    hifa_importdata(vis=['uid___A002_Xc89480_Xf069'], session=['session_1'])
    fixsyscaltimes(vis = 'uid___A002_Xc89480_Xf069.ms')# SACM/JAO - Fixes
