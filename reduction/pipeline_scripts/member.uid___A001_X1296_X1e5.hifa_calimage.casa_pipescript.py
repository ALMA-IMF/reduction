...
context.set_state('ProjectStructure', 'ous_part_id', 'X779421746')
context.set_state('ProjectStructure', 'ous_title', 'Undefined')
context.set_state('ProjectStructure', 'ppr_file', '/opt/dared/opt/c5r1/mnt/dataproc/2017.1.01355.L_2018_01_24T18_40_56.365/SOUS_uid___A001_X1296_X1e3/GOUS_uid___A001_X1296_X1e4/MOUS_uid___A001_X1296_X1e5/working/PPR_uid___A001_X1296_X1e6.xml')
...
context.set_state('ProjectStructure', 'ousstatus_entity_id', 'uid://A001/X1296/X1e5')
try:
    hifa_importdata(vis=['uid___A002_Xc86fe5_X7a9e', 'uid___A002_Xc89480_X57ef'], session=['session_2', 'session_3'])
    fixsyscaltimes(vis = 'uid___A002_Xc86fe5_X7a9e.ms')# SACM/JAO - Fixes
    fixsyscaltimes(vis = 'uid___A002_Xc89480_X57ef.ms')# SACM/JAO - Fixes
