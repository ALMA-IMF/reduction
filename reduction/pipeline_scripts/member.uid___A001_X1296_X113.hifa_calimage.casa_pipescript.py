...
context.set_state('ProjectStructure', 'ous_part_id', 'X1920718863')
context.set_state('ProjectStructure', 'ous_title', 'Undefined')
context.set_state('ProjectStructure', 'ppr_file', '/opt/dared/opt/qa56.1712.1/mnt/dataproc/2017.1.01355.L_2018_07_05T15_32_39.961/SOUS_uid___A001_X1296_X10f/GOUS_uid___A001_X1296_X110/MOUS_uid___A001_X1296_X113/working/PPR_uid___A001_X1296_X114.xml')
...
context.set_state('ProjectStructure', 'ousstatus_entity_id', 'uid://A001/X1296/X113')
try:
    hifa_importdata(vis=['uid___A002_Xcf196f_X9b44'], session=['session_1'])
