...
context.set_state('ProjectStructure', 'ous_part_id', 'X1218302833')
context.set_state('ProjectStructure', 'ous_title', 'Undefined')
context.set_state('ProjectStructure', 'ppr_file', '/opt/dared/opt/qa56.1712.1/mnt/dataproc/2017.1.01355.L_2018_07_02T13_45_11.312/SOUS_uid___A001_X1296_X137/GOUS_uid___A001_X1296_X138/MOUS_uid___A001_X1296_X13b/working/PPR_uid___A001_X1296_X13c.xml')
...
context.set_state('ProjectStructure', 'ousstatus_entity_id', 'uid://A001/X1296/X13b')
try:
    hifa_importdata(vis=['uid___A002_Xcf3a9c_Xec3'], session=['session_1'])
