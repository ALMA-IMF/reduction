...
context.set_state('ProjectStructure', 'ous_part_id', 'X429395440')
context.set_state('ProjectStructure', 'ous_title', 'Undefined')
context.set_state('ProjectStructure', 'ppr_file', '/opsw/alma/dared/opt/c5r1/mnt/dataproc/2017.1.01355.L_2018_05_11T11_12_20.370/SOUS_uid___A001_X1296_X123/GOUS_uid___A001_X1296_X124/MOUS_uid___A001_X1296_X125/working/PPR_uid___A001_X1296_X126.xml')
...
context.set_state('ProjectStructure', 'ousstatus_entity_id', 'uid://A001/X1296/X125')
try:
    hifa_importdata(vis=['uid___A002_Xcaca82_X3786', 'uid___A002_Xcaca82_X41c6'], session=['session_1', 'session_2'])
