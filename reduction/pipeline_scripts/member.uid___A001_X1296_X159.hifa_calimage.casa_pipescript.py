...
context.set_state('ProjectStructure', 'ous_part_id', 'X904428026')
context.set_state('ProjectStructure', 'ous_title', 'Undefined')
context.set_state('ProjectStructure', 'ppr_file', '/opt/dared/opt/c5r1/mnt/dataproc/2017.1.01355.L_2018_05_10T19_01_57.322/SOUS_uid___A001_X1296_X155/GOUS_uid___A001_X1296_X156/MOUS_uid___A001_X1296_X159/working/PPR_uid___A001_X1296_X15a.xml')
...
context.set_state('ProjectStructure', 'ousstatus_entity_id', 'uid://A001/X1296/X159')
try:
    hifa_importdata(vis=['uid___A002_Xcd07af_X5509'], session=['session_1'])
    fixsyscaltimes(vis = 'uid___A002_Xcd07af_X5509.ms')# SACM/JAO - Fixes
