...
context.set_state('ProjectStructure', 'ous_part_id', 'X1587405024')
context.set_state('ProjectStructure', 'ous_title', 'Undefined')
context.set_state('ProjectStructure', 'ppr_file', '/opt/dared/opt/c5r1/mnt/dataproc/2017.1.01355.L_2018_04_06T18_22_11.685/SOUS_uid___A001_X1296_X1b5/GOUS_uid___A001_X1296_X1b6/MOUS_uid___A001_X1296_X1b7/working/PPR_uid___A001_X1296_X1b8.xml')
...
context.set_state('ProjectStructure', 'ousstatus_entity_id', 'uid://A001/X1296/X1b7')
try:
    hifa_importdata(vis=['uid___A002_Xcb4a8e_X362f'], session=['session_1'])
    fixsyscaltimes(vis = 'uid___A002_Xcb4a8e_X362f.ms')# SACM/JAO - Fixes
