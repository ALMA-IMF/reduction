...
# $Id: scriptForPI.py,v 1.24 2018/05/18 06:37:00 dpetry Exp $
...
casalog.post('$Id: scriptForPI.py,v 1.24 2018/05/18 06:37:00 dpetry Exp $', 'INFO', 'scriptForPI')
...
for i in range(len(sdscriptnames)):
    sdscriptasdms.append(sdscriptnames[i].replace('.ms.scriptForSDCalibration.py', ''))
...
for asdmname in scriptasdms + sdscriptasdms:
    ...
    if asdmname in sdscriptasdms:
        execfile('../../script/'+asdmname+'.ms.scriptForSDCalibration.py')
