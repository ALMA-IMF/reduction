...
context.set_state('ProjectStructure', 'ous_part_id', 'X290809056')
context.set_state('ProjectStructure', 'ous_title', 'Undefined')
context.set_state('ProjectStructure', 'ppr_file', '/opt/dared/opt/c5r1/mnt/dataproc/2017.1.01355.L_2017_12_26T14_40_52.283/SOUS_uid___A001_X1296_X155/GOUS_uid___A001_X1296_X156/MOUS_uid___A001_X1296_X15b/working/PPR_uid___A001_X1296_X15c.xml')
...
context.set_state('ProjectStructure', 'ousstatus_entity_id', 'uid://A001/X1296/X15b')
try:
    hifa_importdata(vis=['uid___A002_Xc7e4e4_X3096', 'uid___A002_Xc7e4e4_X352d', 'uid___A002_Xc82bb8_X2b1d'], session=['session_1', 'session_2', 'session_4'])
    fixsyscaltimes(vis = 'uid___A002_Xc7e4e4_X3096.ms')# SACM/JAO - Fixes
    fixsyscaltimes(vis = 'uid___A002_Xc7e4e4_X352d.ms')# SACM/JAO - Fixes
    fixsyscaltimes(vis = 'uid___A002_Xc82bb8_X2b1d.ms')# SACM/JAO - Fixes
