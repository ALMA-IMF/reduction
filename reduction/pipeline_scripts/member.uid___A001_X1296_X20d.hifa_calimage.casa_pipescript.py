...
context.set_state('ProjectStructure', 'ous_part_id', 'X1330828988')
context.set_state('ProjectStructure', 'ous_title', 'Undefined')
context.set_state('ProjectStructure', 'ppr_file', '/opsw/alma/dared/opt/c5r1/mnt/dataproc/2017.1.01355.L_2017_11_20T16_47_54.506/SOUS_uid___A001_X1296_X207/GOUS_uid___A001_X1296_X208/MOUS_uid___A001_X1296_X20d/working/PPR_uid___A001_X1296_X20e.xml')
...
context.set_state('ProjectStructure', 'ousstatus_entity_id', 'uid://A001/X1296/X20d')
try:
    hifa_importdata(vis=['uid___A002_Xc6d2f9_X48c4'], session=['session_1'])
    fixsyscaltimes(vis = 'uid___A002_Xc6d2f9_X48c4.ms')# SACM/JAO - Fixes
