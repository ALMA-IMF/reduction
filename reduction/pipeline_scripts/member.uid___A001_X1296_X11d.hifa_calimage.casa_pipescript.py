...
context.set_state('ProjectStructure', 'ous_part_id', 'X979913155')
context.set_state('ProjectStructure', 'ous_title', 'Undefined')
context.set_state('ProjectStructure', 'ppr_file', '/opsw/alma/dared/opt/c5r1/mnt/dataproc/2017.1.01355.L_2018_05_07T11_11_45.880/SOUS_uid___A001_X1296_X119/GOUS_uid___A001_X1296_X11a/MOUS_uid___A001_X1296_X11d/working/PPR_uid___A001_X1296_X11e.xml')
...
context.set_state('ProjectStructure', 'ousstatus_entity_id', 'uid://A001/X1296/X11d')
try:
    hifa_importdata(vis=['uid___A002_Xcc8b19_X3341', 'uid___A002_Xcc8b19_X394f'], session=['session_1', 'session_2'])
    fixsyscaltimes(vis = 'uid___A002_Xcc8b19_X394f.ms')# SACM/JAO - Fixes
    fixsyscaltimes(vis = 'uid___A002_Xcc8b19_X3341.ms')# SACM/JAO - Fixes
