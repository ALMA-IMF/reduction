...
context.set_state('ProjectStructure', 'ous_part_id', 'X1007242843')
context.set_state('ProjectStructure', 'ous_title', 'Undefined')
context.set_state('ProjectStructure', 'ppr_file', '/opt/dared/opt/c5r1/mnt/dataproc/2017.1.01355.L_2018_05_10T19_02_20.261/SOUS_uid___A001_X1296_X1bd/GOUS_uid___A001_X1296_X1be/MOUS_uid___A001_X1296_X1c1/working/PPR_uid___A001_X1296_X1c2.xml')
...
context.set_state('ProjectStructure', 'ousstatus_entity_id', 'uid://A001/X1296/X1c1')
try:
    hifa_importdata(vis=['uid___A002_Xcd07af_X5288'], session=['session_1'])
    fixsyscaltimes(vis = 'uid___A002_Xcd07af_X5288.ms')# SACM/JAO - Fixes
