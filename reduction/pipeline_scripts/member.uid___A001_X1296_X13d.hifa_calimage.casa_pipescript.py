...
context.set_state('ProjectStructure', 'ous_part_id', 'X1966380684')
context.set_state('ProjectStructure', 'ous_title', 'Undefined')
context.set_state('ProjectStructure', 'ppr_file', 'PPR_uid___A001_X1296_X13e.xml')
...
context.set_state('ProjectStructure', 'ousstatus_entity_id', 'uid://A001/X1296/X13d')
try:
    hifa_importdata(vis=['uid___A002_Xc743d2_X185', 'uid___A002_Xc7b4ea_X4057'], session=['session_1', 'session_2'])
    ...
    flagdata(vis='uid___A002_Xc743d2_X185.ms.h_tsyscal.s6_1.tsyscal.tbl',mode='manual', spw='24:450-550,26:255-340',field='G337.92',flagbackup=False)
    flagdata(vis='uid___A002_Xc743d2_X185.ms.h_tsyscal.s6_1.tsyscal.tbl',mode='manual', spw='30:0-1000',antenna='CM07',correlation='YY',flagbackup=False)
    flagdata(vis='uid___A002_Xc7b4ea_X4057.ms.h_tsyscal.s6_3.tsyscal.tbl',mode='manual', spw='24:450-550,26:255-340',field='G337.92',flagbackup=False)
