...
context.set_state('ProjectStructure', 'ous_part_id', 'X1664536527')
context.set_state('ProjectStructure', 'ous_title', 'Undefined')
context.set_state('ProjectStructure', 'ppr_file', '/opt/dared/opt/qa56.1712.1/mnt/dataproc/2017.1.01355.L_2018_07_05T14_49_57.606/SOUS_uid___A001_X1296_X123/GOUS_uid___A001_X1296_X124/MOUS_uid___A001_X1296_X127/working/PPR_uid___A001_X1296_X128.xml')
...
context.set_state('ProjectStructure', 'ousstatus_entity_id', 'uid://A001/X1296/X127')
try:
    hifa_importdata(vis=['uid___A002_Xcf0c6b_X4685'], session=['session_1'])
