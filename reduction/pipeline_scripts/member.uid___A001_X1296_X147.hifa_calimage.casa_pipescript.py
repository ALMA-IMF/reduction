...
context.set_state('ProjectStructure', 'ous_part_id', 'X1000710514')
context.set_state('ProjectStructure', 'ous_title', 'Undefined')
context.set_state('ProjectStructure', 'ppr_file', 'PPR_uid___A001_X1296_X148.xml')
...
context.set_state('ProjectStructure', 'ousstatus_entity_id', 'uid://A001/X1296/X147')
try:
    hifa_importdata(vis=['uid___A002_Xc6d2f9_X4e1a', 'uid___A002_Xc6e968_X4486', 'uid___A002_Xc6e968_X4866'], session=['session_1', 'session_3', 'session_3'])
    ...
    flagdata(vis='uid___A002_Xc6d2f9_X4e1a.ms.h_tsyscal.s6_1.tsyscal.tbl', mode='manual', field='G337.92', spw='16:950~1100')
    flagdata(vis='uid___A002_Xc6e968_X4486.ms.h_tsyscal.s6_3.tsyscal.tbl', mode='manual', field='G337.92', spw='16:980~1090')
    flagdata(vis='uid___A002_Xc6e968_X4486.ms.h_tsyscal.s6_3.tsyscal.tbl', mode='manual', antenna='CM06', spw='18:1200~2060')
    flagdata(vis='uid___A002_Xc6e968_X4866.ms.h_tsyscal.s6_5.tsyscal.tbl', mode='manual', field='G337.92', spw='16:980~1080')
    flagdata(vis='uid___A002_Xc6e968_X4866.ms.h_tsyscal.s6_5.tsyscal.tbl', mode='manual', field='J1427-4206', antenna='CM06', spw='22:0~1000',correlation='YY')
